...
namespace Attendance.Utilities
{
    ...
    {
        public ICollection<Info.UserInfo> GetAllUserInfo(ZkemClient objZkeeper, int machineNumber)
        {
            ...
            ICollection<Info.UserInfo> lstFPTemplates = new List<Info.UserInfo>();
            ...
            while (objZkeeper.SSR_GetAllUserInfo(machineNumber, out sdwEnrollNumber, out sName, out sPassword, out iPrivilege, out bEnabled))
            {
                for (idwFingerIndex = 0; idwFingerIndex < 10; idwFingerIndex++)
                {
                    ...
                    {
                        Info.UserInfo fpInfo = new Info.UserInfo();
        ...
        public bool UploadFTPTemplate(ZkemClient objZkeeper, int machineNumber, List<Info.UserInfo> lstUserInfo)
        {
